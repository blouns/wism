...
- `eval suite=smoke|focused|readiness|human-readiness|marathon` selects standard Classic AI probe mixes. Use smoke/focused for development, readiness for broad regression, human-readiness for human-vs-computer pressure evidence, and marathon only after readiness is already green.
