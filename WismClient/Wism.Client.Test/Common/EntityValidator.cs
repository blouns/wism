...
namespace Wism.Client.Test.Common
{
    ...
    {
        public static void ValidateLocations(List<MapObjects.Location> locations, Entities.LocationEntity[] locationEntities)
        {
        ...
        public static void ValidateBoon(IBoon boon, Entities.BoonEntity boonEntity)
        {
        ...
        public static void ValidateCities(List<MapObjects.City> cities, Entities.CityEntity[] cityEntities)
        {
        ...
        public static void ValidateProduction(Barracks barracks, Entities.CityEntity cityEntity)
        {
            ...
            if (barracks.HasDeliveries())
            {
                ...
                for (int i = 0; i < cityEntity.ArmiesToDeliver.Length; i++)
                {
        ...
        public static void ValidateArmyInTraining(ArmyInTraining ait, Entities.ArmyInTrainingEntity aitEntity)
        {
        ...
        public static void ValidateTiles(World world, Entities.TileEntity[] tiles, int xBound, int yBound)
        {
            for (int y = 0; y < yBound; y++)
            {
                for (int x = 0; x < xBound; x++)
                {
                    ...
                    if (worldTile.HasArmies())
                    {
                        ...
                        for (int j = 0; j < entityTile.ArmyIds.Length; j++)
                        {
                    ...
                    if (worldTile.HasVisitingArmies())
                    {
                        ...
                        for (int j = 0; j < entityTile.VisitingArmyIds.Length; j++)
                        {
                    ...
                    if (worldTile.HasItems())
                    {
                        ...
                        for (int j = 0; j < entityTile.Items.Length; j++)
                        {
