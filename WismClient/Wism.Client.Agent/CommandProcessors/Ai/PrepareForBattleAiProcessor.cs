...
public class PrepareForBattleAiProcessor : ICommandProcessor
{
    private readonly AsciiGame asciiGame;
    private IWismLogger logger;

    public PrepareForBattleAiProcessor(IWismLoggerFactory loggerFactory, AsciiGame asciiGame)
    {
    ...
    public ActionState Execute(ICommandAction command)
    {
        ...
        BattleAiProcessor.DrawBattleUpdate(attackingPlayer.Clan, attackingArmies, defendingPlayer.Clan, defendingArmies);
